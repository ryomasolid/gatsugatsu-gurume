...
export default function MethodologySection() {
  const items = [
    ...
    {
      title: "GATSU-INDEXについて",
      body: "各店舗に表示しているGATSU-INDEXは、ジャンルのボリューム度（ラーメン・丼・定食などのがっつり系ジャンルかどうか）と駅からの近さをもとに独自に算出した参考スコアです。味や接客の評価値ではありません。",
    },
    {
      title: "更新頻度と正確性",
      body: "掲載情報は約24時間ごとに自動更新されます。ただし営業時間・価格・臨時休業などは変動するため、来店前に店舗の公式情報やGoogleマップで最新状況をご確認ください。",
    },
  ];
